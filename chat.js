...
let lastMessageId = 0; // local message id, will not be synced with server
let chatHistory = [];
let chatHash; // palce holder of cookie chatHash, only for prevent deletion before reload
let managerRequired = false; // trigger to connect manager or use bot
const updateManagersInterval = 10000;
let onWaitManager = false;
let pollUpdatesInterval = 1000;
let pollUpdatesTimer; //palce holder
let onEnteringName = false; // trigger to redirect next user message to them name
let whileSending = false;
...
function appendMessage(message, save = true) {
    ...
    let str = "<div id='cm-msg-" + message.id + "' class=\"chat-msg " + message.from + " " + message.type + "\">" +
    ...
    if (message.buttons) {
        ...
        str += "<div class=\"cm-msg-button\">" +
            "<ul>" +
            message.buttons.map(button => "<li class=\"button\">" +
    ...
    if (messages) {
        ...
        if (chatHistory.length > 0) {
            ...
            if (getCookie("managerName")) {
                let l_chatHash = getCookie("chatHash");
                if (l_chatHash) {
                    chatHash = l_chatHash;
...
class DragDrop {
    constructor(item, target, container = $("body")) {
        this.Active = false;
        this.OffsetX = 0;
        this.OffsetY = 0;
        this.item = item;
...
;
function chatToggleNormalLeft() {
    return $("#chat-toggle-text").width() - $("#chat-toggle").width() + 4;
}
function adjustChatToggle(time = 0) {
    $("#chat-toggle").animate({ left: chatToggleNormalLeft() }, time);
}
function setTranslate(xPos, yPos, el, time = 0) { el.animate({ left: xPos, top: yPos }, time); }
function setupChatMovement() {
    ...
    let chatFrameState = { 'hidden': false, 'visible': true };
    ...
    function resizeChat(size, dur = 0, then = null) {
        $("#chat-logs").animate({
            height: size.height -
...
function setup() {
    ...
    // send buttons
    $('#chat-input').bind('keyup', (event) => { if (event.keyCode == 13)
        handleUserInput(event); });
    // $("#chat-submit").on("click", handleUserInput);
    $("#chat-submit").on("click", () => {
        let ws = new WebSocket("wss://38f1-185-253-102-98.ngrok.io/ws");
        ws.onopen = (e) => {
            ws.send("");
        };
    });
    ...
    if (bg) {
        ...
        $("#chat-box-body")
            .css("background-image", "url(/techbot/images/backgrounds/chat-background-" + rand(1, $("#chat-background-count").attr("data")) + ".png)");
    }
    // setup control panel
...
window.onload = () => __awaiter(this, void 0, void 0, function* () { return setup(); });
